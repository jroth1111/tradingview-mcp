...
(async () => {
  ...
  try {
    const cookies = JSON.parse(fs.readFileSync('.tradingview_cookies.json', 'utf8'));
  ...
  fs.writeFileSync('.tradingview_cookies.json', JSON.stringify(cookies, null, 2));
  console.log('✓ Saved cookies');
  
  // Save requests
  fs.writeFileSync('.scanner_requests.json', JSON.stringify(requests, null, 2));
