...
export function registerBondTools(ctx) {
    const { server, restClient } = ctx;
    server.tool("bond_scan", "Scan bonds using TradingView's bond scanner. Note: Limited columns available (name, description, close, change).", {
    ...
    server.tool("bond_market_overview", "Get bond market overview - top bonds by price or change. Note: Limited sorting due to bond scanner constraints.", {
...
//# sourceMappingURL=bonds.tools.js.map