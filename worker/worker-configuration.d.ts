/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 1768687e0f245aea6812c5f99d10b513)
// Runtime types generated with workerd@1.20251202.0 2025-12-09 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FetchCoordinator";
	}
	interface Env {
		FETCH_COORDINATOR: DurableObjectNamespace<import("./src/index").FetchCoordinator>;
		ASSETS: Fetcher;
		CACHE_META: KVNamespace;
		CACHE_DATA: R2Bucket;
		CACHE_MAX_TOTAL_BYTES?: string;
		CACHE_MAX_FETCHES_PER_MINUTE?: string;
	}
}
