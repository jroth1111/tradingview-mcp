...
| Forward curves | public futures routes captured; uses futures scanner `label-product=futures-forward-curve` plus quote WebSocket fan-out over contract chains | exact scanner body/response schema and more asset-class/interaction variants |
...
- Seasonals remaining decoded study schema and interaction variants; forward-curve exact scanner schema and interaction variants.
