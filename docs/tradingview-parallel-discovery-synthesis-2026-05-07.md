...
3. Public browser runtime: Pine Screener interaction, macro map indicator/country/slider follow-ups, yield curves, and widget interaction follow-ups for Advanced Chart socket-frame postMessage deltas, optional timeline pagination/filtering, and broader preset body schemas.
