...
- Macro maps Worker modeling after default `IRYY`, non-default `GDP`/`UR`/`INTR`/`GDG`, GDP historical series, UI indicator switch, UI historical slider sequencing, country group/list behavior, and quote-field protocol paths proven in `docs/tradingview-macro-maps-browser-runtime-capture-2026-05-07.md`.
